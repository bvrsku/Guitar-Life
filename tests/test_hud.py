...
# Проверяем синтаксис очищенного файла
try:
    import py_compile
    py_compile.compile('guitar_life_clean.py', doraise=True)
    print("✓ guitar_life_clean.py синтаксически корректен")
except py_compile.PyCompileError as e:
    print(f"✗ Ошибка синтаксиса в guitar_life_clean.py: {e}")
...
try:
    ...
    from guitar_life_clean import HUD, UISlider, UIButton
