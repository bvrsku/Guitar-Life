...
class SimpleColors:
    ...
    GRAY_900 = (30, 30, 30)
    SURFACE = (255, 255, 255)
    SURFACE_VARIANT = (240, 240, 255)
    PRIMARY = (60, 120, 255)
    PRIMARY_LIGHT = (120, 180, 255)
    ACTIVE = (200, 220, 255)
    BORDER = (180, 180, 200)
    BORDER_FOCUS = (60, 120, 255)
    TEXT_PRIMARY = (30, 30, 30)
    TEXT_SECONDARY = (100, 100, 100)
    HOVER = (220, 235, 255)
    SELECTED = (200, 220, 255)
...
class LayerConfig:
    ...
    solo: bool = False
    mute: bool = False
    spawn_method: str = "Стабильные блоки"
...
class UIButton:
    ...
    def draw(self, surface, font):
        """Отрисовка кнопки"""
        bg_color = SimpleColors.PRIMARY if self.active else SimpleColors.GRAY_400
        pygame.draw.rect(surface, bg_color, self.rect, border_radius=8)

        # Отрисовка текста кнопки
        if self.label:
            label_surface = font.render(self.label, True, SimpleColors.SURFACE)
    ...
    #                 num_to_clear = np.random.randint(1, len(alive_cells) + 1)
    ...
    def run(self):          
        ...
        while running:
            ...
            pitch_queue = np.array(pitch_queue)
            rms_queue = np.array(rms_queue)
