...
try:
    ...
    from guitar_life import PALETTE_STATE, _PALETTE_ALIASES, palette_key
    from guitar_life import color_from_age_rms, hue_fire_from_t, hue_ocean_from_t, hue_neon_from_t, hue_ukraine_from_t
